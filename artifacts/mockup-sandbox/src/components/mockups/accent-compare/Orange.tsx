  ...
  return (
    <div style={{ background: bg, color: textPrimary, fontFamily: "'Inter', sans-serif", minHeight: "100vh" }}>
      ...
      <div style={{ background: textPrimary, color: bg, padding: "0.875rem 2rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <button style={{ background: accent, color: bg, border: "none", fontFamily: "'Space Mono', monospace", fontSize: "0.65rem", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700, padding: "0.45rem 1.25rem", cursor: "pointer" }}>Subscribe</button>
      </div>
