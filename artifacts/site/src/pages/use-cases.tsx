      ...
      <main className="max-w-[1200px] mx-auto p-6 md:p-12 min-h-[60vh]">
        <div className="mb-12 border-b-4 border-news pb-8 animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-news-secondary font-serif leading-relaxed max-w-3xl">
            Real-world deployments and applied AI stories — how organizations are putting artificial intelligence to work.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <>
            {featured && (
              <Link
                ...
                data-testid={`link-use-cases-featured-${featured.slug}`}
              >
                <article>
            ...
            {rest.length > 0 && (
              <section className="animate-fade-in-up">
                <div className="border-t-4 border-news pt-2 mb-8">
                  <h3 className="font-mono text-xs font-bold uppercase tracking-widest">More Use Cases</h3>
                </div>
                <div className="space-y-0">
                  {rest.map((article, index) => (
                    <Link
                      ...
                      data-testid={`link-use-cases-${article.slug}`}
                    >
          ...
          <div className="border border-dashed border-news py-32 text-center animate-fade-in-up">
            <p className="font-mono text-sm uppercase tracking-widest text-news-secondary mb-2">No Use Cases Yet</p>
            <p className="font-serif text-news-secondary italic text-lg">No use cases yet. Check back soon.</p>
          </div>
        )}
      </main>
