...
export const ListArticlesResponseItem = zod.object({
  ...
  "spotlightLogoUrl": zod.string().nullish().describe('Company logo URL for spotlight articles; null for all other categories')
})
...
export const SubmitDraftResponse = zod.object({
  ...
  "category": zod.string(),
  "author": zod.string(),
  "authorId": zod.number().nullish().describe('ID of the linked author record'),
  "authorProfile": zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "slug": zod.string(),
...
export const CreateDraftBody = zod.object({
  ...
  "authorId": zod.number().nullish().describe('ID of an author record; if set, overrides the author text field display'),
